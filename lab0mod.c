...
int main(void)
{
	...
	LATB = 0;
        ...
        LATBbits.LATB15 = 1; //use latch output equal to 1 to send signal for LEDs to be off unless otherwise specified in the loop
        LATBbits.LATB14 = 1;
        LATBbits.LATB13 = 1;
        LATBbits.LATB12 = 1;
	...
	TRISBbits.TRISB13 = 0;
	TRISBbits.TRISB12 = 0;
        TRISBbits.TRISB5  = 1; //set pin 14 equal to 1 using RB5 to make SW1 an input
